...
path = '/Users/Nida Ramzan/Downloads/ParkinsonIA-master/lib/trainedModel.sav'
clf = loadModel(path)
filePath = "unknow"
...
class App():
    ...
    def startrecording(self):
        ...
        textTest1 = "This is our semester project of Artificial Intelligence. "
        textTest2 = "The project is given by sir saad, our AI instructor.  "
        textTest3 = " AI Parkinson detector is created to detect parkinson patients"
        testText4 = " with the help of speech recognition tecnique. "


        self.textParkiTest = Label(app, text=textTest, font=('bold', '13'), bg='SteelBlue1')
        self.textParkiTest.place(x=0, y=270)

        self.textParkiTest1 = Label(app, text=textTest1, font=('normal', '11'), bg='cyan2')
        self.textParkiTest1.place(x=0, y=300)
        self.textParkiTest2 = Label(app, text=textTest2, font=('normal', '11'), bg='cyan2')
        self.textParkiTest2.place(x=0, y=320)
        self.textParkiTest3 = Label(app, text=textTest3, font=('normal', '11'), bg='cyan2')
        self.textParkiTest3.place(x=0, y=340)
        self.textParkiTest4 = Label(app, text=testText4, font=('normal', '11'), bg='cyan2')
...
def execAI():
    ...
    if (filePath != "unknow") and (filePath != ""):
        if predict(clf, filePath):
            ...
            # Display answer
            part_label1 = Label(app, text='Yes', font=('bold', 14), bg='maroon1', pady=20)
            ...
            # Display answer
            part_label2 = Label(app, text='No', font=('bold', 14), bg='maroon1', pady=20)
        ...
        # Display answer
        part_label3 = Label(app, text=errmsg, font=('bold', 14), bg='maroon1', pady=20)
...
# background
filename = PhotoImage(file="/Users/Nida Ramzan/Downloads/ParkinsonIA-master/img/bn3-bg.png")
...
# Label
part_label = Label(app, text='Do you have Parkinson ?', bg='cyan2', font=('bold', 14), pady=20)
